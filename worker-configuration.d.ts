/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7e8db934f3531f9c86f421b01f3aeb6e)
// Runtime types generated with workerd@1.20260826.1 2026-08-28 
interface __BaseEnv_Env {
	MAP_SNAPSHOTS: KVNamespace;
	AUTH_DB: D1Database;
	...
	GATEWAY_BRIDGE_SECRET: string;
	WORLD_PRESENCE: DurableObjectNamespace<import("./worker/index").GuildPresence>;
	DISCORD_GATEWAY_BRIDGE: DurableObjectNamespace<import("./worker/index").DiscordGatewayBridge>;
	GAME_CHAT: DurableObjectNamespace<import("./worker/index").GameChat>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "GuildPresence" | "DiscordGatewayBridge" | "GameChat";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_BOT_TOKEN" | "DISCORD_GUILD_ID" | "MAP_SLUG" | "SYNC_SECRET" | "PUBLICATION_ALLOWLIST_JSON" | "SNAPSHOT_ID_SECRET" | "DISCORD_CLIENT_ID" | "DISCORD_CLIENT_SECRET" | "AUTH_SESSION_SECRET" | "GATEWAY_BRIDGE_SECRET">> {}
}
