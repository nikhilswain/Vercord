...
for i in range(2):
    ...
    atlas(f'gate-{i}','lattice.png',32,32,[(i*32,f*32) for f in range(12)])
...
for file in ['LICENSE-CraftPix.txt','CREDITS.md']:
    ...
    if file == 'LICENSE-CraftPix.txt':
        ...
        note = note.replace('Selected production PNG rectangles extracted at native resolution.',
            'Selected production PNG frames and static Aseprite lamp layers extracted at native resolution.')
